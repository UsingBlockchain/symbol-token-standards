 ...
 * @since v0.5.0
 * @description Class that describes a token command for removing operators for NIP13 compliant tokens.
 * @summary
 ...
 */
export class RevokeIssuerPower extends AbstractCommand {
  /**
  ...
  public get descriptor(): string {
    return 'NIP13(v' + this.context.revision + ')' + ':remove-operator:' + this.identifier.id
  }

  /**
   * @description Builds the inner transactions necessary for the
   *              execution of a `RevokeIssuerPower` command.
